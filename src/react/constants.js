...
export const TAG_ROOT = Symbol.for('tag.root'); // 作为fiber.tag的值，表示根fiber;
...
export const PLACEMENT = Symbol.for('placement'); // 表示插入节点的Effect
export const UPDATE = Symbol.for('update'); // 表示更新/移动节点的Effect
export const DELETE = Symbol.for('delete'); // 表示删除节点的Effect